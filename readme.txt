...
= 0.4.3 =
* Keep the CyberEdge reverse-proxy policy explicit when LiteSpeed Cache is active at the origin.
* Refresh the WordPress dashboard to match the current CyberPanel interface and improve responsive layout.
